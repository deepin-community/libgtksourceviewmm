...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    char* retval = (*base->get_name)(self);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    GdkPixbuf* retval = (*base->get_icon)(self);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->match)
  {
    gboolean retval = (*base->match)(self, context);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    GtkSourceCompletionActivation retval = (*base->get_activation)(self);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    GtkWidget* retval = (*base->get_info_widget)(self, proposal);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->get_start_iter)(self, context, proposal, iter);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    gboolean retval = (*base->activate_proposal)(self, proposal, iter);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    int retval = (*base->get_interactive_delay)(self);
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(self), CppObjectType::get_type()) // Get the interface.
  ...
  {
    int retval = (*base->get_priority)(self);
    return retval;
  }
...
CompletionProvider::CompletionProvider(CompletionProvider&& src) noexcept
: Glib::Interface(std::move(src))
{}

CompletionProvider& CompletionProvider::operator=(CompletionProvider&& src) noexcept
{
  Glib::Interface::operator=(std::move(src));
  return *this;
}

CompletionProvider::~CompletionProvider() noexcept
{}
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_name)
  {
    Glib::ustring retval(Glib::convert_const_gchar_ptr_to_ustring((*base->get_name)(const_cast<GtkSourceCompletionProvider*>(gobj()))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_icon)
  {
    Glib::RefPtr<Gdk::Pixbuf> retval(Glib::wrap((*base->get_icon)(gobj()), true));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->match)
  {
    bool retval((*base->match)(const_cast<GtkSourceCompletionProvider*>(gobj()),const_cast<GtkSourceCompletionContext*>(Glib::unwrap(context))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_activation)
  {
    CompletionActivation retval(((CompletionActivation)((*base->get_activation)(const_cast<GtkSourceCompletionProvider*>(gobj())))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_info_widget)
  {
    Gtk::Widget* retval(Glib::wrap((*base->get_info_widget)(const_cast<GtkSourceCompletionProvider*>(gobj()),const_cast<GtkSourceCompletionProposal*>(Glib::unwrap(proposal)))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_start_iter)
  {
    bool retval((*base->get_start_iter)(gobj(),const_cast<GtkSourceCompletionContext*>(Glib::unwrap(context)),const_cast<GtkSourceCompletionProposal*>(Glib::unwrap(proposal)),(iter).gobj()));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->activate_proposal)
  {
    bool retval((*base->activate_proposal)(gobj(),Glib::unwrap(proposal),const_cast<GtkTextIter*>((iter).gobj())));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_interactive_delay)
  {
    int retval((*base->get_interactive_delay)(const_cast<GtkSourceCompletionProvider*>(gobj())));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_priority)
  {
    int retval((*base->get_priority)(const_cast<GtkSourceCompletionProvider*>(gobj())));
    return retval;
  }
