...
CompletionWords::CompletionWords(CompletionWords&& src) noexcept
: Glib::Object(std::move(src))
  , CompletionProvider(std::move(src))
{}

CompletionWords& CompletionWords::operator=(CompletionWords&& src) noexcept
{
  Glib::Object::operator=(std::move(src));
  CompletionProvider::operator=(std::move(src));
  return *this;
}

CompletionWords::~CompletionWords() noexcept
{}
