...
{
  return manage(new GutterRendererPixbuf((GtkSourceGutterRendererPixbuf*)(o)));
...
GutterRendererPixbuf::GutterRendererPixbuf(GutterRendererPixbuf&& src) noexcept
: GutterRenderer(std::move(src))
{}

GutterRendererPixbuf& GutterRendererPixbuf::operator=(GutterRendererPixbuf&& src) noexcept
{
  GutterRenderer::operator=(std::move(src));
  return *this;
}

GutterRendererPixbuf::~GutterRendererPixbuf() noexcept
{
  destroy_();
}
