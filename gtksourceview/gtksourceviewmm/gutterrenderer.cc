...
static gboolean GutterRenderer_signal_query_tooltip_callback(GtkSourceGutterRenderer* self, GtkTextIter* p0,GdkRectangle* p1,gint p2,gint p3,GtkTooltip* p4,void* data)
{
  ...
  auto obj = dynamic_cast<GutterRenderer*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
{
  return manage(new GutterRenderer((GtkSourceGutterRenderer*)(o)));
...
GutterRenderer::GutterRenderer(GutterRenderer&& src) noexcept
: Gtk::Object(std::move(src))
{}

GutterRenderer& GutterRenderer::operator=(GutterRenderer&& src) noexcept
{
  Gtk::Object::operator=(std::move(src));
  return *this;
}

GutterRenderer::~GutterRenderer() noexcept
{
  destroy_();
}
