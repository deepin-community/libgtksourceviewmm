...
static const gchar* MarkAttributes_signal_query_tooltip_text_callback(GtkSourceMarkAttributes* self, GtkSourceMark* p0,void* data)
{
  ...
  auto obj = dynamic_cast<MarkAttributes*>(Glib::ObjectBase::_get_current_wrapper((GObject*) self));
...
MarkAttributes::MarkAttributes(MarkAttributes&& src) noexcept
: Glib::Object(std::move(src))
{}

MarkAttributes& MarkAttributes::operator=(MarkAttributes&& src) noexcept
{
  Glib::Object::operator=(std::move(src));
  return *this;
}

MarkAttributes::~MarkAttributes() noexcept
{}
